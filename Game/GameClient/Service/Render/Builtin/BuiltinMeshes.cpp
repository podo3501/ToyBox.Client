...
static std::shared_ptr<MeshAsset> CreateUIQuadAsset()
{
	...
	std::vector<UIVertex> vertices =
	{
		...
		{ { 0.0f, 0.0f, 0.0f }, Core::Color::White, { 0.0f, 0.0f }, UIRenderMode::UI, 0, 0.f }, // 0, 좌상단
		{ { 1.0f, 0.0f, 0.0f }, Core::Color::White, { 1.0f, 0.0f }, UIRenderMode::UI, 0, 0.f }, // 1, 우상단
		{ { 1.0f, 1.0f, 0.0f }, Core::Color::White, { 1.0f, 1.0f }, UIRenderMode::UI, 0, 0.f }, // 2, 우하단
		{ { 0.0f, 1.0f, 0.0f }, Core::Color::White, { 0.0f, 1.0f }, UIRenderMode::UI, 0, 0.f }, // 3, 좌하단
	};
