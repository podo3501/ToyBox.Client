...
inline filesystem::path GetResourceFullFilename(const filesystem::path& filename) noexcept { 
    return EnvCall(&Environment::GetResourceFullFilename, filename); }
inline filesystem::path GetRelativePath(const filesystem::path& fullPath) noexcept {
