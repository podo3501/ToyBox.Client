...
Resource ResourceLoader::CreateUploadResource(size_t size)
{
...
Resource ResourceLoader::CreateTextureResource(const D3D12_RESOURCE_DESC& desc)
{
...
Resource ResourceLoader::CreateBufferResource(UINT64 size)
{
    return CreateResource(
        CreateBufferDesc(size),
        D3D12_HEAP_TYPE_DEFAULT,
...
Resource ResourceLoader::CreateShadowResource(UINT width, UINT height)
{
...
Resource ResourceLoader::CreateResource(
